...
The primary goal of this is educational: to explain the role of each Kubernetes component and how they work together to form a functioning cluster.

This is NOT a guide for setting up production-ready clusters. In some instances, the examples deliberately use simplified or insecure configurations to make the learning experience more accessible and help you focus on understanding the core concepts.
...
builds upon the previous ones, gradually introducing new concepts and components.

Additionally starts with a playground environment that includes all previously installed components from earlier , so you can focus on new material without rebuilding everything from scratch.
...
includes dedicated lab environments, so you can focus entirely on learning without setting up or managing virtual machines.
